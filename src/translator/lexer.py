...
token_specification = [
    ...
    ('COMMENT', r';[^\n]*'),  # Comment
    ('OPCODE',
     r'(?i)(pushf|popf|push|str|pop|inc|dec|swap|dup|nop|jmp|call|ret|halt|int|iret|ei|di|in|out|add|sub|mul|div|and|or|xor|not|neg|ld|st|cmp|jz|je|jnz|jg|jge|jl|jle|res|byte|char|shl|shr|rol|ror|addr)[^a-zA-Z0-9_]'),
    # Opcode
